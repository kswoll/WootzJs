...
namespace System
{
    ...
    public class AggregateException : Exception 
    {
        ...
        {
            m_innerExceptions = new List<Exception>(new Exception[0]); 
        }
        ...
        { 
            ...
            m_innerExceptions = new List<Exception>(new Exception[] { innerException });
        } 
            ...
            : base(message, innerExceptions != null && innerExceptions.Count > 0 ? innerExceptions[0] : null)
        {
            ...
            m_innerExceptions = new List<Exception>(exceptionsCopy); 
        } 

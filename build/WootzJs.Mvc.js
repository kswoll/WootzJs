...
(WootzJs.Mvc.Mvc.Views.Control.$TypeInitializer = function($t, $p) {
    ...
    $p.$NodeCreationText$k__BackingField = null;
    $p.get_NodeCreationText = function() {return this.$NodeCreationText$k__BackingField;};
    $p.set_NodeCreationText = function(value) {this.$NodeCreationText$k__BackingField = value;};
    $p.node = null;
    $p.children = null;
    $p.style = null;
    $p.click = null;
    ...
    $p.$ctor = function() {
        ...
        this.set_NodeCreationText("<div></div>");
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
    };
    $p.$ctor$1 = function(nodeCreationText) {
        System.Object.prototype.$ctor.call(this);
        this.children = System.Collections.Generic.List$1$(WootzJs.Mvc.Mvc.Views.Control).prototype.$ctor.$new();
        this.set_NodeCreationText(nodeCreationText);
    };
    $p.$ctor$1.$type = $t;
    $p.$ctor$1.$new = function(nodeCreationText) {
        return new $p.$ctor$1.$type(this, nodeCreationText);
    };
    ...
    $p.set_Style = function(value) {
        this.style = value;
        this.style.Attach(this.node);
    };
    $p.get_Node = function() {
        return this.EnsureNodeExists();
    };
    $p.CreateNode = function() {
        return $(this.get_NodeCreationText());
    };
    $p.EnsureNodeExists = function() {
        if (this.node == null) {
            this.node = this.CreateNode();
            this.node.attr("data-class-name", this.GetType().get_FullName());
            if (this.style != null)
                this.style.Attach(this.node);
        }
        return this.node;
    ...
    $p.Click = function(handler) {
        if (this.click == null) {
            this.get_Node().click($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsClick));
    ...
    $p.UnClick = function(handler) {
        if (this.click != null) {
            ...
            if (!System.Linq.Enumerable.Any(System.Action, this.click)) {
                this.click = null;
                this.get_Node().unbind("click", $delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsClick));
            }
        }
    };
    $p.MouseEnter = function(handler) {
        if (this.mouseEnter == null) {
            this.get_Node().mouseenter($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsMouseEnter));
    ...
    $p.UnMouseEnter = function(handler) {
        if (this.mouseEnter != null) {
            ...
            if (!System.Linq.Enumerable.Any(System.Action, this.mouseEnter)) {
                ...
                this.get_Node().unbind("mouseenter", $delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsMouseEnter));
            }
        }
    };
    $p.MouseLeave = function(handler) {
        if (this.mouseLeave == null) {
            this.get_Node().mouseleave($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsMouseLeave));
    ...
    $p.UnMouseLeave = function(handler) {
        if (this.mouseLeave != null) {
            ...
            if (!System.Linq.Enumerable.Any(System.Action, this.mouseLeave)) {
                ...
                this.get_Node().unbind("mouseleave", $delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsMouseLeave));
            }
        }
    };
...
(WootzJs.Mvc.Mvc.Views.TablePanel.$TypeInitializer = function($t, $p) {
    ...
    $p.$ctor = function(columnWidths) {
        ...
        this.rows = System.Collections.Generic.List$1$($).prototype.$ctor.$new();
            ...
            while ($anon$2enumerator.System$Collections$IEnumerator$MoveNext()) {
                ...
                switch (width.get_Style()) {
                    case WootzJs.Mvc.Mvc.Views.TableWidthStyle().Pixels:
                        col.css("width", $safeToString(width.get_Value()) + "px");
                        break;
                    case WootzJs.Mvc.Mvc.Views.TableWidthStyle().Weight:
                        ...
                        extraPercent = 0;
                        col.css("width", $safeToString(currentWeight) + "%");
                        break;
                    case WootzJs.Mvc.Mvc.Views.TableWidthStyle().Percent:
                        col.css("width", $safeToString(width.get_Value()) + "%");
                        break;
                }
                colgroup.append(col);
            }
    ...
    $p.Add$2 = function(cell, constraint) {
        ...
        if (constraint.get_ColumnSpan() != 1)
            jsCell.attr("colspan", constraint.get_ColumnSpan());
        if (constraint.get_RowSpan() != 1)
            jsCell.attr("rowspan", constraint.get_RowSpan());
        var jsCellDiv = $("<div></div>");
        ...
        switch (constraint.get_VerticalAlignment()) {
            ...
            case WootzJs.Mvc.Mvc.Views.VerticalAlignment().Fill:
                cell.get_Node().css("height", "100%");
                jsCellDiv.css("height", "100%");
                break;
        }
        jsCellDiv.append(cell.get_Node());
...
(WootzJs.Mvc.Mvc.Views.CenteredPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.CreateNode = function() {
        ...
        td.append(this.contentContainer);
        row.append(td);
    ...
    $p.set_Content = function(value) {
        if (this.content != null) {
            ...
            this.content.get_Node().remove();
        }
        this.content = value;
        if (this.content != null) {
            this.Add(this.content);
            var childNode = value.get_Node();
            this.contentContainer.append(childNode);
        }
    };
...
(WootzJs.Mvc.Mvc.Views.CheckBox.$TypeInitializer = function($t, $p) {
    ...
    $p.CreateNode = function() {
        ...
        this.checkbox.change($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsChanged));
        span.append(this.checkbox);
...
(WootzJs.Mvc.Mvc.Views.DropDown.$TypeInitializer = function($t, $p) {
    ...
    $p.set_Content = function(value) {
        ...
        if (this.content != null) {
            this.Add(value);
            this.contentNode.append(this.content.get_Node());
        }
    };
    ...
    $p.set_Overlay = function(value) {
        if (this.overlay != null) {
            ...
            this.overlay.get_Node().remove();
        }
        this.overlay = value;
        if (this.overlay != null) {
            this.Add(this.overlay);
            this.overlayContainer.append(this.overlay.get_Node());
        }
    };
    $p.CreateNode = function() {
        this.contentNode = $("<div></div>");
        this.overlayContainer = $("<div></div>");
        this.overlayContainer.css("position", "absolute");
        this.overlayContainer.css("display", "none");
        var overlayAnchor = $("<div></div>");
        overlayAnchor.css("position", "relative");
        overlayAnchor.append(this.overlayContainer);
        var result = $("<div></div>");
        result.append(this.contentNode);
        result.append(overlayAnchor);
        result.mouseenter($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsContentMouseEnter));
        result.mouseleave($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsContentMouseLeave));
        return result;
    };
    $p.OnJsContentMouseEnter = function(arg) {
        if (this.overlay != null)
            this.overlayContainer.css("display", "");
    };
...
(WootzJs.Mvc.Mvc.Views.FillPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.set_Content = function(value) {
        ...
        if (this.content != null) {
            ...
            this.get_Node().append(childNode);
        }
    };
...
(WootzJs.Mvc.Mvc.Views.FixedPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.set_Content = function(value) {
        ...
        if (this.content != null) {
            this.Add(this.content);
            this.get_Node().append(this.content.get_Node());
            this.content.get_Node().css("width", "100%");
            this.content.get_Node().css("height", "100%");
        }
    };
...
(WootzJs.Mvc.Mvc.Views.HorizontalPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.set_HorizontalAlignment = function(value) {
        ...
        switch (value) {
            case WootzJs.Mvc.Mvc.Views.HorizontalAlignment().Fill:
                break;
            case WootzJs.Mvc.Mvc.Views.HorizontalAlignment().Center:
                this.firstSpacer = $("<td></td>");
                this.firstSpacer.css("width", "50%");
                this.row.prepend(this.firstSpacer);
                this.lastSpacer = $("<td></td>");
                this.lastSpacer.css("width", "50%");
                this.row.append(this.lastSpacer);
                break;
            case WootzJs.Mvc.Mvc.Views.HorizontalAlignment().Left:
                this.lastSpacer = $("<td></td>");
                this.lastSpacer.css("width", "100%");
                this.row.append(this.lastSpacer);
                break;
            case WootzJs.Mvc.Mvc.Views.HorizontalAlignment().Right:
                this.firstSpacer = $("<td></td>");
                this.firstSpacer.css("width", "100%");
                this.row.prepend(this.firstSpacer);
                break;
            default:
                throw System.InvalidOperationException.prototype.$ctor.$new().InternalInit(new Error());
    ...
    $p.Add$4 = function(child, alignment, spaceBefore) {
        ...
        div.append(child.get_Node());
        if (this.lastSpacer != null)
            cell.insertBefore(this.lastSpacer);
        else
...
(WootzJs.Mvc.Mvc.Views.HtmlControl.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {};
    $p.$ctor = function(nodeCreationText) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, nodeCreationText);
        this.EnsureNodeExists();
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function(nodeCreationText) {
        return new $p.$ctor.$type(this, nodeCreationText);
    };
    $p.Add$1 = function(child) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.Add.call(this, child);
        this.get_Node().append(child.get_Node());
    };
    $p.Remove$1 = function(child) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.Remove.call(this, child);
        child.get_Node().remove();
    };
...
(WootzJs.Mvc.Mvc.Views.Image.$TypeInitializer = function($t, $p) {
    ...
    $p.get_Source = function() {
        return this.get_Node().attr("src");
    };
    $p.set_Source = function(value) {
        this.get_Node().attr("src", value);
    };
    $p.CreateNode = function() {
        var node = $("<img />");
...
(WootzJs.Mvc.Mvc.Views.Link.$TypeInitializer = function($t, $p) {
    ...
    $p.get_Text = function() {
        return this.get_Node().text();
    };
    $p.set_Text = function(value) {
        if (!this.useTextMode)
            this.get_Node().empty();
        this.get_Node().text(value);
...
(WootzJs.Mvc.Mvc.Views.SidePanel.$TypeInitializer = function($t, $p) {
    ...
    $p.GetTopRow = function() {
        if (this.topRow == null) {
            this.topRow = $("<tr></tr>");
            this.get_Node().prepend(this.topRow);
        }
        return this.topRow;
    };
    $p.GetMiddleRow = function() {
        if (this.middleRow == null) {
            this.middleRow = $("<tr></tr>");
            if (this.topRow != null)
                this.middleRow.insertAfter(this.topRow);
            else
                this.get_Node().prepend(this.middleRow);
        }
        return this.middleRow;
    };
    $p.GetBottomRow = function() {
        if (this.bottomRow == null) {
            this.bottomRow = $("<tr></tr>");
            this.get_Node().append(this.bottomRow);
        }
    ...
    $p.GetTopCell = function() {
        if (this.topCell == null) {
            this.topCell = $("<td></td>");
            this.topCell.attr("colspan", 3);
            this.GetTopRow().append(this.topCell);
            this.topCellContent = $("<div></div>");
            this.topCellContent.css("width", "100%");
            this.topCellContent.css("height", "100%");
            this.topCell.append(this.topCellContent);
            if (this.get_Spacing() != 0 && (this.middleRow != null || this.bottomRow != null)) {
                this.topCellContent.css("padding-bottom", Number.op_Implicit$23(this.get_Spacing()));
            }
        }
    ...
    $p.GetBottomCell = function() {
        if (this.bottomCell == null) {
            this.bottomCell = $("<td></td>");
            this.bottomCell.attr("colspan", 3);
            this.GetBottomRow().append(this.bottomCell);
            this.bottomCellContent = $("<div></div>");
            this.bottomCellContent.css("width", "100%");
            this.bottomCellContent.css("height", "100%");
            this.bottomCell.append(this.bottomCellContent);
            if (this.get_Spacing() != 0 && (this.middleRow != null)) {
                this.bottomCellContent.css("padding-top", this.get_Spacing());
            }
        }
    ...
    $p.AdjustColSpan = function() {
        if (this.leftCell != null)
            this.leftCell.attr("colspan", this.center == null && this.right == null ? 3 : 1);
        if (this.centerCell != null)
            this.centerCell.attr("colspan", this.left != null && this.right != null ? 1 : this.left != null || this.right != null ? 2 : 3);
        if (this.rightCell != null)
            this.rightCell.attr("colspan", this.center == null && this.left == null ? 3 : 1);
    };
    $p.GetLeftCell = function() {
        if (this.leftCell == null) {
            this.leftCell = $("<td></td>");
            this.leftCell.css("height", "100%");
            this.AdjustColSpan();
            this.GetMiddleRow().prepend(this.leftCell);
            this.leftCellContent = $("<div></div>");
            this.leftCellContent.css("width", "100%");
            this.leftCellContent.css("height", "100%");
            this.leftCell.append(this.leftCellContent);
            if (this.get_Spacing() != 0 && (this.centerCell != null || this.rightCell != null)) {
                this.leftCellContent.css("padding-left", this.get_Spacing());
            }
        }
    ...
    $p.GetCenterCell = function() {
        if (this.centerCell == null) {
            this.centerCell = $("<td></td>");
            this.centerCell.css("height", "100%");
            this.centerCell.css("width", "100%");
            this.AdjustColSpan();
            if (this.leftCell != null)
                this.centerCell.insertAfter(this.leftCell);
            else
                this.GetMiddleRow().prepend(this.centerCell);
            this.centerCellContent = $("<div></div>");
            this.centerCellContent.css("width", "100%");
            this.centerCellContent.css("height", "100%");
            this.centerCell.append(this.centerCellContent);
        }
        return this.centerCellContent;
    };
    $p.GetRightCell = function() {
        if (this.rightCell == null) {
            this.rightCell = $("<td></td>");
            this.rightCell.css("height", "100%");
            this.AdjustColSpan();
            this.GetMiddleRow().append(this.rightCell);
            this.rightCellContent = $("<div></div>");
            this.rightCellContent.css("width", "100%");
            this.rightCellContent.css("height", "100%");
            this.rightCell.append(this.rightCellContent);
            if (this.get_Spacing() != 0 && this.middleRow != null) {
                this.rightCellContent.css("padding-left", this.get_Spacing());
            }
        }
    ...
    $p.RemoveMiddleRow = function() {
        if (this.middleRow != null) {
            ...
            if (this.topCell != null && this.bottom == null)
                this.topCell.css("padding-bottom", "");
        }
        this.middleRow = null;
    };
    ...
    $p.RemoveCenterCell = function() {
        if (this.centerCell != null) {
            ...
            if (this.leftCell != null && this.right == null)
                this.leftCell.css("padding-right", "");
        }
    ...
    $p.set_Top = function(value) {
        ...
        if (this.top != null) {
            this.Add(this.top);
            this.GetTopCell().append(value.get_Node());
        }
    };
    $p.get_Bottom = function() {
        return this.bottom;
    ...
    $p.set_Bottom = function(value) {
        ...
        if (this.bottom != null) {
            ...
            this.GetBottomCell().append(value.get_Node());
        }
    };
    $p.get_Left = function() {
        return this.left;
    ...
    $p.set_Left = function(value) {
        ...
        if (this.left != null) {
            this.Add(this.left);
            this.GetLeftCell().append(value.get_Node());
        }
    };
    ...
    $p.set_Center = function(value) {
        ...
        if (this.center != null) {
            ...
            this.GetCenterCell().append(value.get_Node());
        }
    };
    $p.get_Right = function() {
        return this.right;
    ...
    $p.set_Right = function(value) {
        ...
        if (this.right != null) {
            this.Add(this.right);
            this.GetRightCell().append(value.get_Node());
        }
    };
...
(WootzJs.Mvc.Mvc.Views.Text.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {};
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "<span></span>");
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
...
(WootzJs.Mvc.Mvc.Views.TextBox.$TypeInitializer = function($t, $p) {
    ...
    $p.CreateNode = function() {
        ...
        textBox.change($delegate(this, WootzJs.JQuery.JqEventHandler, this.OnJsChanged));
        return textBox;
    };
    $p.OnJsChanged = function(evt) {
        var changed = this.$Changed$k__BackingField;
    ...
    $p.get_Text = function() {
        this.EnsureNodeExists();
        return this.get_Node().val().ToString();
    };
    $p.set_Text = function(value) {
        this.EnsureNodeExists();
        this.get_Node().val(value);
    };

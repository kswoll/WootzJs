...
(WootzJs.Mvc.Mvc.Views.Control.$TypeInitializer = function($t, $p) {
    ...
    $p.$AttachedToDom$k__BackingField = null;
    $p.add_AttachedToDom = function(value) {
        this.$AttachedToDom$k__BackingField = System.Delegate.Combine(this.$AttachedToDom$k__BackingField, value);
    };
    $p.remove_AttachedToDom = function(value) {
        this.$AttachedToDom$k__BackingField = System.Delegate.Remove(this.$AttachedToDom$k__BackingField, value);
    };
    ...
    $p.mouseEntered = null;
    $p.mouseExited = null;
    $p.isAttachedToDom = false;
    $p.view = null;
    $p.$ctor$1 = function(tagName) {
    ...
    $p.$ctor$1.$type = $t;
    $p.$ctor$1.$new = function(tagName) {
        return new $p.$ctor$1.$type(this, tagName);
    };
    $p.$ctor = function(node) {
        System.Object.prototype.$ctor.call(this);
        this.children = System.Collections.Generic.List$1$(WootzJs.Mvc.Mvc.Views.Control).prototype.$ctor.$new();
        this.set_Node(node);
        this.isAttachedToDom = WootzJs.Web.ElementExtensions.IsAttachedToDom(node);
    };
    $p.$ctor.$type = $t;
    ...
    $p.get_IsAttachedToDom = function() {
    ...
    $p.OnAdded = function() {
        if (this.get_Parent().isAttachedToDom)
            this.OnAttachedToDom();
    };
    $p.OnRemoved = function() {};
    $p.add_Click = function(value) {
        if (this.click == null)
        ...
        this.click = $cast(System.Action$1$(Event), System.Delegate.Combine(this.click, value));
    };
    $p.remove_Click = function(value) {
        this.click = $cast(System.Action$1$(Event), System.Delegate.Remove(this.click, value));
        if (this.click == null)
    ...
    $p.add_MouseEntered = function(value) {
        ...
        this.mouseEntered = $cast(System.Action, System.Delegate.Combine(this.mouseEntered, value));
    };
    $p.remove_MouseEntered = function(value) {
        this.mouseEntered = $cast(System.Action, System.Delegate.Remove(this.mouseEntered, value));
        if (this.mouseEntered == null)
    ...
    $p.add_MouseExited = function(value) {
        ...
        this.mouseExited = $cast(System.Action, System.Delegate.Combine(this.mouseExited, value));
    };
    $p.remove_MouseExited = function(value) {
        this.mouseExited = $cast(System.Action, System.Delegate.Remove(this.mouseExited, value));
        if (this.mouseExited == null)
    ...
    $p.OnAttachedToDom = function() {
        this.isAttachedToDom = true;
        var attachedToDom = this.$AttachedToDom$k__BackingField;
        if (attachedToDom != null)
            attachedToDom();
        {
            var $anon$1iterator = this.get_Children();
            ...
            while ($anon$2enumerator.System$Collections$IEnumerator$MoveNext()) {
                var child = $anon$2enumerator.System$Collections$IEnumerator$get_Current();
                child.OnAttachedToDom();
            }
        }
    };
    $p.OnAddedToView = function() {
        {
            var $anon$1iterator = this.get_Children();
            var $anon$2enumerator = $anon$1iterator.System$Collections$IEnumerable$GetEnumerator();
            while ($anon$2enumerator.System$Collections$IEnumerator$MoveNext()) {
                var child = $anon$2enumerator.System$Collections$IEnumerator$get_Current();
                child.set_View(this.get_View());
                child.OnAddedToView();
            }
        }
    };
    $p.NotifyOnAddedToView = function() {
        this.OnAddedToView();
    };
...
(WootzJs.Mvc.Mvc.Routes.RoutePart.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RoutePart.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RoutePart.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.TablePanel.$TypeInitializer = function($t, $p) {
    ...
    $p.$ctor = function(columnWidths) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
        ...
        this.set_DefaultConstraint(WootzJs.Mvc.Mvc.Views.TableConstraint.prototype.$ctor.$new(
            3, 
            3, 
            1, 
            1
    ...
    $p.get_CellSpacing = function() {
        return this.cellSpacing;
    };
    $p.set_CellSpacing = function(value) {
        this.cellSpacing = value;
        for (var i = 0; i < this.rows.get_Count(); i++) {
            var row = this.rows.get_Item(i);
            for (var j = 0; j < row.children.length; j++) {
                var cell = row.children.item(j);
                var isLastCellInRow = j == row.children.length - 1;
                var isLastRowInTable = i == this.rows.get_Count() - 1;
                if (!isLastCellInRow)
                    cell.style.paddingRight = $safeToString(this.cellSpacing) + "px";
                if (!isLastRowInTable)
                    cell.style.paddingBottom = $safeToString(this.cellSpacing) + "px";
            }
        }
    };
    $p.CreateNode = function() {
    ...
    $p.Add$2 = function(cell, constraint) {
        ...
        constraint = constraint || this.get_DefaultConstraint();
        if (nextEmptyCell.X + constraint.get_ColumnSpan() > this.columnWidths.length)
            throw System.InvalidOperationException.prototype.$ctor$1.$new(String.Format("Added a cell at position ({0},{1}), but the column ({2}) exceeds the available remaining space in the row ({3}).", [
                nextEmptyCell.X, 
                nextEmptyCell.Y, 
        ...
        for (var row = nextEmptyCell.Y; row < nextEmptyCell.Y + constraint.get_RowSpan(); row++) {
            for (var col = nextEmptyCell.X; col < nextEmptyCell.X + constraint.get_ColumnSpan(); col++) {
                while (this.cells.get_Count() <= row) {
                    if (this.cellSpacing > 0 && System.Linq.Enumerable.Any(Element, this.rows)) {
                        var lastRow = System.Linq.Enumerable.Last(Element, this.rows);
                        for (var i = 0; i < lastRow.children.length; i++) {
                            var lastCell = lastRow.children.item(i);
                            lastCell.style.paddingBottom = $safeToString(this.cellSpacing) + "px";
                        }
                    }
        ...
        var isLastCellInRow = nextEmptyCell.X + constraint.get_ColumnSpan() == this.columnWidths.length;
        if (!isLastCellInRow && this.cellSpacing != 0)
            jsCell.style.paddingRight = $safeToString(this.cellSpacing) + "px";
    ...
    ($t.Point.$TypeInitializer = function($t, $p) {
        ...
        $t.$StaticInitializer = function() {
            if (WootzJs.Mvc.Mvc.Views.TablePanel.Point.$isStaticInitialized)
                return;
            WootzJs.Mvc.Mvc.Views.TablePanel.Point.$isStaticInitialized = true;
            System.Object.$StaticInitializer();
        };
        $p.X = 0;
        $p.Y = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.Css.CssValue.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssValue.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.View.$TypeInitializer = function($t, $p) {
    ...
    $p.OnInitialize = function() {
        if (this.get_Content() != null)
            this.get_Content().NotifyOnAddedToView();
    };
...
($AnonymousType$1.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if ($AnonymousType$1.$isStaticInitialized)
            return;
...
(WootzJs.Mvc.ExpressionTrees.Evaluator.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.ExpressionTrees.Evaluator.$isStaticInitialized)
            return;
        WootzJs.Mvc.ExpressionTrees.Evaluator.$isStaticInitialized = true;
...
(WootzJs.Mvc.ExpressionTrees.EvaluatorExtensions.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.ExpressionTrees.EvaluatorExtensions.$isStaticInitialized)
            return;
        WootzJs.Mvc.ExpressionTrees.EvaluatorExtensions.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.ExpressionTrees.GenericMath.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.ExpressionTrees.GenericMath.$isStaticInitialized)
            return;
        WootzJs.Mvc.ExpressionTrees.GenericMath.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.ActionResult.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.ActionResult.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.ActionResult.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Controller.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Controller.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Controller.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.ControllerActionInvoker.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.ControllerActionInvoker.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.ControllerActionInvoker.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.ControllerContext.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.ControllerContext.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.ControllerContext.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.DefaultAttribute.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.DefaultAttribute.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.DefaultAttribute.$isStaticInitialized = true;
...
(WootzJs.Mvc.Mvc.DefaultControllerFactory.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.DefaultControllerFactory.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.DefaultControllerFactory.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.HttpPostAttribute.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.HttpPostAttribute.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.HttpPostAttribute.$isStaticInitialized = true;
        System.Attribute.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Attribute.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.IActionInvoker.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.IActionInvoker.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.IActionInvoker.$isStaticInitialized = true;
    };
...
(WootzJs.Mvc.Mvc.IControllerFactory.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.IControllerFactory.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.IControllerFactory.$isStaticInitialized = true;
    };
...
(WootzJs.Mvc.Mvc.MvcApplication.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.MvcApplication.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.MvcApplication.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
    ...
    $p.Start = function(assembly) {
        ...
        WootzJs.Web.Browser().get_Window().addEventListener("popstate", $delegate(this, System.Action$1$(Event), function(evt) {
            return this.OnPopState(evt);
        }));
...
(WootzJs.Mvc.Mvc.NavigationContext.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.NavigationContext.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.NavigationContext.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.NavigationRequest.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.NavigationRequest.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.NavigationRequest.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.NavigationResponse.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.NavigationResponse.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.NavigationResponse.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.RouteAttribute.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.RouteAttribute.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.RouteAttribute.$isStaticInitialized = true;
        System.Attribute.$StaticInitializer();
    };
    $p.$Value$k__BackingField = null;
...
(WootzJs.Mvc.Mvc.Routes.DuplicateRouteException.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.DuplicateRouteException.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.DuplicateRouteException.$isStaticInitialized = true;
...
(WootzJs.Mvc.Mvc.Routes.IRouteNode.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.IRouteNode.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.IRouteNode.$isStaticInitialized = true;
    };
...
(WootzJs.Mvc.Mvc.Routes.IRoutePart.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.IRoutePart.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.IRoutePart.$isStaticInitialized = true;
    };
...
(WootzJs.Mvc.Mvc.Routes.RouteBuilder.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteBuilder.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteBuilder.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
    ...
    ($t.Pinned.$TypeInitializer = function($t, $p) {
        ...
        $t.$StaticInitializer = function() {
            if (WootzJs.Mvc.Mvc.Routes.RouteBuilder.Pinned.$isStaticInitialized)
                return;
            WootzJs.Mvc.Mvc.Routes.RouteBuilder.Pinned.$isStaticInitialized = true;
            System.Object.$StaticInitializer();
        };
        $p.builder = null;
        $p.accepted = false;
...
(WootzJs.Mvc.Mvc.Routes.RouteData.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteData.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteData.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
...
(WootzJs.Mvc.Mvc.Routes.RouteDefault.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteDefault.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteDefault.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Routes.RoutePart.$StaticInitializer();
    };
    $p.$ctor = function(routeData) {
...
(WootzJs.Mvc.Mvc.Routes.RouteGenerator.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteGenerator.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteGenerator.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Routes.RouteLiteral.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteLiteral.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteLiteral.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Routes.RoutePart.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Routes.RouteNode.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteNode.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteNode.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Routes.RoutePath.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RoutePath.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RoutePath.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.remaining = null;
    $p.consumed = null;
    ...
    ($t.Pinned.$TypeInitializer = function($t, $p) {
        ...
        $t.$StaticInitializer = function() {
            if (WootzJs.Mvc.Mvc.Routes.RoutePath.Pinned.$isStaticInitialized)
                return;
            WootzJs.Mvc.Mvc.Routes.RoutePath.Pinned.$isStaticInitialized = true;
            System.Object.$StaticInitializer();
        };
        $p.path = null;
        $p.$ctor = function(path) {
...
(WootzJs.Mvc.Mvc.Routes.RouteTree.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteTree.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteTree.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Routes.RouteVariable.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteVariable.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteVariable.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Routes.RoutePart.$StaticInitializer();
    };
    $p.$IsTerminal$k__BackingField = false;
    $p.get_IsTerminal = function() {return this.$IsTerminal$k__BackingField;};
...
(WootzJs.Mvc.Mvc.Routes.RouteWildcard.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Routes.RouteWildcard.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Routes.RouteWildcard.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Routes.RoutePart.$StaticInitializer();
    };
    $p.parameter = null;
...
(WootzJs.Mvc.Mvc.MiscExtensions.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.MiscExtensions.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.MiscExtensions.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.ViewContext.$TypeInitializer = function($t, $p) {
    ...
    $p.$Url$k__BackingField = null;
    $p.get_Url = function() {return this.$Url$k__BackingField;};
    $p.set_Url = function(value) {this.$Url$k__BackingField = value;};
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
        this.set_Action(WootzJs.Mvc.Mvc.Views.ActionHelper.prototype.$ctor.$new(this));
        this.set_Url(WootzJs.Mvc.Mvc.Views.UrlHelper.prototype.$ctor.$new(this));
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
...
(WootzJs.Mvc.Mvc.ViewResult.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.ViewResult.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.ViewResult.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.ActionResult.$StaticInitializer();
    };
    $p.$View$k__BackingField = null;
    $p.get_View = function() {return this.$View$k__BackingField;};
    $p.set_View = function(value) {this.$View$k__BackingField = value;};
...
(WootzJs.Mvc.Mvc.Views.ActionHelper.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.ActionHelper.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.ActionHelper.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.viewContext = null;
    ...
    ($t.ActionControllerHelper$1.$TypeInitializer = function($t, $p, TController) {
        ...
        $t.$StaticInitializer = function() {
            if (WootzJs.Mvc.Mvc.Views.ActionHelper.ActionControllerHelper$1$(TController).$isStaticInitialized)
                return;
            WootzJs.Mvc.Mvc.Views.ActionHelper.ActionControllerHelper$1$(TController).$isStaticInitialized = true;
            System.Object.$StaticInitializer();
        };
...
(WootzJs.Mvc.Mvc.Views.AlignmentPanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.AlignmentPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.AlignmentPanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.TablePanel.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.CenteredPanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.CenteredPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.CenteredPanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.content = null;
...
(WootzJs.Mvc.Mvc.Views.CheckBox.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.CheckBox.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.CheckBox.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssBorder.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssBorder.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssBorder.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
    $p.$ctor = function() {
...
(WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapse.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapse.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapse.$isStaticInitialized = true;
...
(WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapses.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapses.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssBorderCollapses.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssBorderSide.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssBorderSide.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssBorderSide.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.Css.CssBoxShadow.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssBoxShadow.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssBoxShadow.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.Css.CssColor.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssColor.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssColor.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$StaticInitializer();
...
(WootzJs.Mvc.Mvc.Views.Css.CssCursor.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssCursor.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssCursor.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Alias = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssCursors.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssCursors.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssCursors.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssFont.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFont.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFont.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.Css.CssFontStyle.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFontStyle.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFontStyle.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Normal = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssFontStyles.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFontStyles.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFontStyles.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssFontWeight.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFontWeight.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFontWeight.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.value = null;
...
(WootzJs.Mvc.Mvc.Views.Css.CssFontWeightType.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFontWeightType.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFontWeightType.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Normal = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssFontWeightTypes.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssFontWeightTypes.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssFontWeightTypes.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $t.GetName = function(value) {
        switch (value) {
...
(WootzJs.Mvc.Mvc.Views.Css.CssInherit.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssInherit.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssInherit.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$StaticInitializer();
...
(WootzJs.Mvc.Mvc.Views.Css.CssInset.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssInset.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssInset.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$StaticInitializer();
...
(WootzJs.Mvc.Mvc.Views.Css.CssMargin.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssMargin.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssMargin.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssNameAttribute.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssNameAttribute.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssNameAttribute.$isStaticInitialized = true;
        System.Attribute.$StaticInitializer();
    };
    $p.name = null;
...
(WootzJs.Mvc.Mvc.Views.Css.CssNumericValue.$TypeInitializer = function($t, $p) {
    ...
    $t.op_Explicit = function(numeric) {
        if (numeric.get_Unit() == WootzJs.Mvc.Mvc.Views.Css.CssUnit().Pixels)
            return System.Int32.Parse(numeric.get_Value());
        else
            throw System.Exception.prototype.$ctor$1.$new("Cannot cast a non-pixel numeric into an int").InternalInit(new Error());
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssPadding.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssPadding.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssPadding.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Css.CssDeclaration.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.Css.CssPercent.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssPercent.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssPercent.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$StaticInitializer();
    };
    $p.value = 0;
    $p.$ctor = function(value) {
...
(WootzJs.Mvc.Mvc.Views.Css.CssString.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssString.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssString.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Css.CssValue.$StaticInitializer();
    };
    $p.value = null;
    $p.$ctor = function(value) {
...
(WootzJs.Mvc.Mvc.Views.Css.CssTextAlign.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssTextAlign.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssTextAlign.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Left = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssUnit.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssUnit.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssUnit.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Pixels = 0;
...
(WootzJs.Mvc.Mvc.Views.Css.CssUnits.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssUnits.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssUnits.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Top = 0;
...
WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns = $define("WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns", System.Object);
(WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = System.Object;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("CssVerticalAligns", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns", WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns, System.Object, $arrayinit([], System.Type), $arrayinit([], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("GetCssValue", WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.prototype.GetCssValue, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("value", WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), String, System.Reflection.MethodAttributes().Public | System.Reflection.MethodAttributes().Static, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("Parse", WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.prototype.Parse, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("s", String, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign, System.Reflection.MethodAttributes().Public | System.Reflection.MethodAttributes().Static, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $t.GetCssValue = function(value) {
        return System.Enum.InternalToObject(WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign, value).ToString().toLowerCase();
    };
    $t.Parse = function(s) {
        switch (s) {
            case "top":
                return WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign().Top;
            case "middle":
                return WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign().Middle;
            case "bottom":
                return WootzJs.Mvc.Mvc.Views.Css.CssVerticalAlign().Bottom;
            default:
                throw System.InvalidOperationException.prototype.$ctor$1.$new("Unknown text align: " + s).InternalInit(new Error());
        }
    };
}).call(null, WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns, WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.Css.CssVerticalAligns);
...
(WootzJs.Mvc.Mvc.Views.Css.Style.$TypeInitializer = function($t, $p) {
    ...
    $p.get_BorderSpacing = function() {
        return WootzJs.Mvc.Mvc.Views.Css.CssNumericValue.Parse$1(this.Get("border-spacing"));
    };
    $p.set_BorderSpacing = function(value) {
...
(WootzJs.Mvc.Mvc.Views.DropDown.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.DropDown.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.DropDown.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.content = null;
    $p.overlay = null;
...
(WootzJs.Mvc.Mvc.Views.FillPanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.FillPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.FillPanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.content = null;
    $p.$ctor = function() {
...
WootzJs.Mvc.Mvc.Views.FixedHeaderPanel = $define("WootzJs.Mvc.Mvc.Views.FixedHeaderPanel", WootzJs.Mvc.Mvc.Views.Control);
(WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = WootzJs.Mvc.Mvc.Views.Control;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.FixedHeaderPanel";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("FixedHeaderPanel", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.FixedHeaderPanel", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel, WootzJs.Mvc.Mvc.Views.Control, $arrayinit([], System.Type), $arrayinit([System.Reflection.FieldInfo.prototype.$ctor.$new("header", WootzJs.Mvc.Mvc.Views.Control, System.Reflection.FieldAttributes().Private, null, $arrayinit([], System.Attribute)), System.Reflection.FieldInfo.prototype.$ctor.$new("content", WootzJs.Mvc.Mvc.Views.Control, System.Reflection.FieldAttributes().Private, null, $arrayinit([], System.Attribute))], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("get_Header", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.get_Header, $arrayinit([], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("set_Header", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.set_Header, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("value", WootzJs.Mvc.Mvc.Views.Control, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Void, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("FixHeight", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.FixHeight, $arrayinit([], System.Reflection.ParameterInfo), System.Void, System.Reflection.MethodAttributes().Private, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("get_Content", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.get_Content, $arrayinit([], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("set_Content", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.set_Content, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("value", WootzJs.Mvc.Mvc.Views.Control, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Void, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("CreateNode", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.CreateNode, $arrayinit([], System.Reflection.ParameterInfo), Element, System.Reflection.MethodAttributes().Family, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.$ctor, $arrayinit([], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.PropertyInfo.prototype.$ctor.$new("Header", WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodInfo.prototype.$ctor.$new("get_Header", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.get_Header, $arrayinit([], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("set_Header", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.set_Header, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("value", WootzJs.Mvc.Mvc.Views.Control, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Void, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), $arrayinit([], System.Reflection.ParameterInfo), $arrayinit([], System.Attribute)), System.Reflection.PropertyInfo.prototype.$ctor.$new("Content", WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodInfo.prototype.$ctor.$new("get_Content", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.get_Content, $arrayinit([], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.Control, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.MethodInfo.prototype.$ctor.$new("set_Content", WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype.set_Content, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("value", WootzJs.Mvc.Mvc.Views.Control, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Void, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), $arrayinit([], System.Reflection.ParameterInfo), $arrayinit([], System.Attribute))], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
    ...
    $p.headerNode = null;
    $p.contentNode = null;
    $p.get_Header = function() {
        return this.header;
    };
    $p.set_Header = function(value) {
        this.EnsureNodeExists();
        if (this.header != null) {
            this.Remove(this.header);
            WootzJs.Web.ElementExtensions.Clear(this.headerNode);
        }
        this.header = value;
        if (value != null) {
            this.headerNode.appendChild(value.get_Node());
            if (this.get_IsAttachedToDom())
                this.FixHeight();
            else
                value.add_AttachedToDom($delegate(
                    this, 
                    System.Action, 
                    this.FixHeight, 
                    "FixHeight$delegate"
    ...
    $p.FixHeight = function() {
        this.contentNode.style.paddingTop = $safeToString(this.header.get_Node().offsetHeight) + "px";
        this.header.remove_AttachedToDom($delegate(
            this, 
            System.Action, 
            this.FixHeight, 
            "FixHeight$delegate"
    ...
    $p.set_Content = function(value) {
        ...
        if (this.content != null) {
            this.Remove(this.content);
            WootzJs.Web.ElementExtensions.Clear(this.contentNode);
        }
        this.content = value;
        if (value != null) {
            this.contentNode.appendChild(value.get_Node());
            this.Add(this.content);
        }
    };
    $p.CreateNode = function() {
        this.headerNode = WootzJs.Web.Browser().get_Document().createElement("div");
        ...
        result.appendChild(this.headerNode);
        result.appendChild(this.contentNode);
        return result;
    };
}).call(null, WootzJs.Mvc.Mvc.Views.FixedHeaderPanel, WootzJs.Mvc.Mvc.Views.FixedHeaderPanel.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.FixedHeaderPanel);
...
(WootzJs.Mvc.Mvc.Views.FixedPanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.FixedPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.FixedPanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.content = null;
    $p.$ctor = function() {
...
(WootzJs.Mvc.Mvc.Views.FlowPanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.FlowPanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.FlowPanel.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.HorizontalAlignment.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.HorizontalAlignment.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.HorizontalAlignment.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Left = 0;
...
(WootzJs.Mvc.Mvc.Views.HorizontalPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.$DefaultAlignment$k__BackingField = 0;
    $p.get_DefaultAlignment = function() {return this.$DefaultAlignment$k__BackingField;};
    $p.set_DefaultAlignment = function(value) {this.$DefaultAlignment$k__BackingField = value;};
    $p.row = null;
    $p.firstSpacer = null;
    $p.lastSpacer = null;
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
        this.set_DefaultAlignment(WootzJs.Mvc.Mvc.Views.VerticalAlignment().Fill);
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
    ...
    $p.Add$1 = function(child) {
        this.Add$4(child, this.get_DefaultAlignment(), this.get_Count() == 0 ? 0 : this.get_Spacing());
    };
    ...
    $p.Add$3 = function(child, spaceBefore) {
        this.Add$4(child, this.get_DefaultAlignment(), (this.get_Count() == 0 ? 0 : this.get_Spacing()) + spaceBefore);
    };
...
WootzJs.Mvc.Mvc.Views.HorizontalRule = $define("WootzJs.Mvc.Mvc.Views.HorizontalRule", WootzJs.Mvc.Mvc.Views.Control);
(WootzJs.Mvc.Mvc.Views.HorizontalRule.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = WootzJs.Mvc.Mvc.Views.Control;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.HorizontalRule";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("HorizontalRule", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.HorizontalRule", WootzJs.Mvc.Mvc.Views.HorizontalRule, WootzJs.Mvc.Mvc.Views.Control, $arrayinit([], System.Type), $arrayinit([], System.Reflection.FieldInfo), $arrayinit([], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.HorizontalRule.prototype.$ctor, $arrayinit([], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.HorizontalRule.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.HorizontalRule.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "hr");
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
    };
}).call(null, WootzJs.Mvc.Mvc.Views.HorizontalRule, WootzJs.Mvc.Mvc.Views.HorizontalRule.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.HorizontalRule);
WootzJs.Mvc.Mvc.Views.Html = $define("WootzJs.Mvc.Mvc.Views.Html", WootzJs.Mvc.Mvc.Views.Control);
(WootzJs.Mvc.Mvc.Views.Html.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = WootzJs.Mvc.Mvc.Views.Control;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.Html";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("Html", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.Html", WootzJs.Mvc.Mvc.Views.Html, WootzJs.Mvc.Mvc.Views.Control, $arrayinit([], System.Type), $arrayinit([System.Reflection.FieldInfo.prototype.$ctor.$new("html", String, System.Reflection.FieldAttributes().Private, null, $arrayinit([], System.Attribute))], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("CreateNode", WootzJs.Mvc.Mvc.Views.Html.prototype.CreateNode, $arrayinit([], System.Reflection.ParameterInfo), Element, System.Reflection.MethodAttributes().Family, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.Html.prototype.$ctor, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("html", String, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Html.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Html.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.html = null;
    $p.$ctor = function(html) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
        this.html = html;
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function(html) {
        return new $p.$ctor.$type(this, html);
    };
    $p.CreateNode = function() {
        var result = WootzJs.Web.Browser().get_Document().createElement("span");
        result.innerHTML = this.html;
        return result;
    };
}).call(null, WootzJs.Mvc.Mvc.Views.Html, WootzJs.Mvc.Mvc.Views.Html.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.Html);
...
(WootzJs.Mvc.Mvc.Views.HtmlControl.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.HtmlControl.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.HtmlControl.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function(node) {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor.call(this, node);
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function(node) {
        return new $p.$ctor.$type(this, node);
...
WootzJs.Mvc.Mvc.Views.InlineControl = $define("WootzJs.Mvc.Mvc.Views.InlineControl", WootzJs.Mvc.Mvc.Views.Control);
(WootzJs.Mvc.Mvc.Views.InlineControl.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = WootzJs.Mvc.Mvc.Views.Control;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.InlineControl";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("InlineControl", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.InlineControl", WootzJs.Mvc.Mvc.Views.InlineControl, WootzJs.Mvc.Mvc.Views.Control, $arrayinit([], System.Type), $arrayinit([], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("op_Implicit$1", WootzJs.Mvc.Mvc.Views.InlineControl.prototype.op_Implicit$1, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("text", String, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.InlineControl, System.Reflection.MethodAttributes().Public | System.Reflection.MethodAttributes().Static, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.InlineControl.prototype.$ctor, $arrayinit([], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute)), System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor$1", WootzJs.Mvc.Mvc.Views.InlineControl.prototype.$ctor$1, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("node", Element, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.InlineControl.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.InlineControl.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
    ...
    $t.op_Implicit$1 = function(text) {
        return WootzJs.Mvc.Mvc.Views.Text.prototype.$ctor$1.$new(text);
    };
}).call(null, WootzJs.Mvc.Mvc.Views.InlineControl, WootzJs.Mvc.Mvc.Views.InlineControl.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.InlineControl);
WootzJs.Mvc.Mvc.Views.Image = $define("WootzJs.Mvc.Mvc.Views.Image", WootzJs.Mvc.Mvc.Views.InlineControl);
(WootzJs.Mvc.Mvc.Views.Image.$TypeInitializer = function($t, $p) {
    ...
    $p.$ctor$2 = function(defaultSource, highlightedSource) {
        ...
        this.add_MouseEntered($delegate(this, System.Action, function() {
            return this.set_Source(highlightedSource);
        }));
        this.add_MouseExited($delegate(this, System.Action, function() {
    ...
    $p.get_Width = function() {
        return System.Int32.Parse(this.get_Node().getAttribute("width"));
    };
    $p.set_Width = function(value) {
        this.get_Node().setAttribute("width", value.ToString());
    };
    $p.get_Height = function() {
        return System.Int32.Parse(this.get_Node().getAttribute("height"));
    };
    $p.set_Height = function(value) {
        this.get_Node().setAttribute("height", value.ToString());
    };
...
(WootzJs.Mvc.Mvc.Views.Layout.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.Layout.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.Layout.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.View.$StaticInitializer();
    };
    $p.$ctor = function() {
...
(WootzJs.Mvc.Mvc.Views.LinkPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.get_LocalHref = function() {
        return this.localHref;
    };
    $p.set_LocalHref = function(value) {
        this.EnsureNodeExists();
        if (this.localHref != null) {
            this.get_Node().setAttribute("href", "javascript:void(0);");
            this.remove_Click($delegate(
                this, 
                System.Action$1$(Event), 
                this.LocalHrefClick, 
                "LocalHrefClick$delegate"
            ));
        }
        this.localHref = value;
        if (this.localHref != null) {
            this.get_Node().setAttribute("href", value);
            this.add_Click($delegate(
                this, 
                System.Action$1$(Event), 
                this.LocalHrefClick, 
                "LocalHrefClick$delegate"
    ...
    $p.LocalHrefClick = function(evt) {
        this.get_ViewContext().get_ControllerContext().get_Application().Open(this.get_Node().getAttribute("href"));
        evt.preventDefault();
    };
    $p.CreateNode = function() {
        var a = WootzJs.Web.Browser().get_Document().createElement("a");
...
(WootzJs.Mvc.Mvc.Views.MouseTrackingEngine.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.MouseTrackingEngine.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.MouseTrackingEngine.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Mvc.Mvc.Views.SidePanel.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.SidePanel.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.SidePanel.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
...
(WootzJs.Mvc.Mvc.Views.TableConstraint.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.TableConstraint.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.TableConstraint.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.TableWidth.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.TableWidth.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.TableWidth.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Mvc.Mvc.Views.TableWidthStyle.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.TableWidthStyle.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.TableWidthStyle.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Pixels = 0;
...
WootzJs.Mvc.Mvc.Views.Text = $define("WootzJs.Mvc.Mvc.Views.Text", WootzJs.Mvc.Mvc.Views.InlineControl);
...
(WootzJs.Mvc.Mvc.Views.TextBox.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.TextBox.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.TextBox.$isStaticInitialized = true;
        WootzJs.Mvc.Mvc.Views.Control.$StaticInitializer();
    };
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
...
(WootzJs.Mvc.Mvc.Views.UrlGenerator.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.UrlGenerator.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.UrlGenerator.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
    ...
    $t.GenerateUrl = function(action) {
        ...
        var controllerDefaultAttribute = $cast(WootzJs.Mvc.Mvc.DefaultAttribute, System.Linq.Enumerable.SingleOrDefault(System.Object, method.get_DeclaringType().GetCustomAttributes$1(WootzJs.Mvc.Mvc.DefaultAttribute.$GetType(), false)));
        ...
        var defaultAttribute = $cast(WootzJs.Mvc.Mvc.DefaultAttribute, System.Linq.Enumerable.SingleOrDefault(System.Object, method.GetCustomAttributes$1(WootzJs.Mvc.Mvc.DefaultAttribute.$GetType(), false)));
        if (controllerDefaultAttribute != null && defaultAttribute != null)
            result.Append$2("/");
        else
            if (defaultAttribute != null)
                result.Append$2("/" + WootzJs.Mvc.Mvc.Views.UrlGenerator.GetControllerNameFromType(method.get_DeclaringType()));
            else
...
WootzJs.Mvc.Mvc.Views.UrlHelper = $define("WootzJs.Mvc.Mvc.Views.UrlHelper", System.Object);
(WootzJs.Mvc.Mvc.Views.UrlHelper.$TypeInitializer = function($t, $p) {
    $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
    $p.$type = $t;
    $t.$baseType = System.Object;
    $p.$typeName = "WootzJs.Mvc.Mvc.Views.UrlHelper";
    $t.$typeName = $p.$typeName;
    $t.$GetType = function() {
        return System.Type._GetTypeFromTypeFunc(this);
    };
    $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("UrlHelper", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.UrlHelper", WootzJs.Mvc.Mvc.Views.UrlHelper, System.Object, $arrayinit([], System.Type), $arrayinit([System.Reflection.FieldInfo.prototype.$ctor.$new("viewContext", WootzJs.Mvc.Mvc.ViewContext, System.Reflection.FieldAttributes().Private, null, $arrayinit([], System.Attribute))], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("On", WootzJs.Mvc.Mvc.Views.UrlHelper.prototype.On, $arrayinit([], System.Reflection.ParameterInfo), WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.UrlHelper.prototype.$ctor, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("viewContext", WootzJs.Mvc.Mvc.ViewContext, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.UrlHelper.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.UrlHelper.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.viewContext = null;
    $p.$ctor = function(viewContext) {
    ...
    $p.On = function(TController) {
        return WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1$(TController).prototype.$ctor.$new(this.viewContext);
    };
    $t.ActionControllerHelper$1 = $define("WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper<TController>", System.Object);
    ($t.ActionControllerHelper$1.$TypeInitializer = function($t, $p, TController) {
        $t.$GetAssembly = window.$WootzJs$Mvc$GetAssembly;
        $p.$type = $t;
        $t.$baseType = System.Object;
        $p.$typeName = "WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper`1";
        $t.$typeName = $p.$typeName;
        $t.$GetType = function() {
            return System.Type._GetTypeFromTypeFunc(this);
        };
        $t.$CreateType = function() {this.$type = System.Type.prototype.$ctor.$new("ActionControllerHelper", $arrayinit([], System.Attribute));this.$type.Init("WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper`1", WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1, System.Object, $arrayinit([], System.Type), $arrayinit([System.Reflection.FieldInfo.prototype.$ctor.$new("viewContext", WootzJs.Mvc.Mvc.ViewContext, System.Reflection.FieldAttributes().Private, null, $arrayinit([], System.Attribute))], System.Reflection.FieldInfo), $arrayinit([System.Reflection.MethodInfo.prototype.$ctor.$new("To", WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1.prototype.To, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("action", System.Linq.Expressions.Expression$1, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), String, System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([System.Reflection.ConstructorInfo.prototype.$ctor.$new("$ctor", WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1.prototype.$ctor, $arrayinit([System.Reflection.ParameterInfo.prototype.$ctor.$new("viewContext", WootzJs.Mvc.Mvc.ViewContext, 0, 0, null, $arrayinit([], System.Attribute))], System.Reflection.ParameterInfo), System.Reflection.MethodAttributes().Public, $arrayinit([], System.Attribute))], System.Reflection.MethodInfo), $arrayinit([], System.Reflection.PropertyInfo), $arrayinit([], System.Reflection.EventInfo), false);return this.$type;};
        $t.$StaticInitializer = function() {
            if (WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1$(TController).$isStaticInitialized)
                return;
            WootzJs.Mvc.Mvc.Views.UrlHelper.ActionControllerHelper$1$(TController).$isStaticInitialized = true;
            System.Object.$StaticInitializer();
        };
        this.ActionControllerHelper$1$ = function() {
            return $generic.call(this, this.ActionControllerHelper$1, arguments);
        ...
        $p.To = function(TActionResult, action) {
            return WootzJs.Mvc.Mvc.Views.UrlGenerator.GenerateUrl(action);
        };
    }).call($t, $t.ActionControllerHelper$1, $t.ActionControllerHelper$1.prototype);
    $WootzJs$Mvc$AssemblyTypes.push($t.ActionControllerHelper$1);
}).call(null, WootzJs.Mvc.Mvc.Views.UrlHelper, WootzJs.Mvc.Mvc.Views.UrlHelper.prototype);
$WootzJs$Mvc$AssemblyTypes.push(WootzJs.Mvc.Mvc.Views.UrlHelper);
...
(WootzJs.Mvc.Mvc.Views.VerticalAlignment.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.VerticalAlignment.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.VerticalAlignment.$isStaticInitialized = true;
        System.Enum.$StaticInitializer();
        $t.Top = 0;
...
(WootzJs.Mvc.Mvc.Views.VerticalPanel.$TypeInitializer = function($t, $p) {
    ...
    $p.$ctor = function() {
        WootzJs.Mvc.Mvc.Views.Control.prototype.$ctor$1.call(this, "div");
        this.set_DefaultAlignment(WootzJs.Mvc.Mvc.Views.HorizontalAlignment().Fill);
    };
    $p.$ctor.$type = $t;
    $p.$ctor.$new = function() {
        return new $p.$ctor.$type(this);
    };
    $p.get_VerticalAlignment = function() {
        if (this.firstSpacer == null && this.lastSpacer == null)
            return WootzJs.Mvc.Mvc.Views.VerticalAlignment().Fill;
        else
            if (this.firstSpacer != null && this.lastSpacer != null)
                return WootzJs.Mvc.Mvc.Views.VerticalAlignment().Middle;
            else
                if (this.firstSpacer != null)
                    return WootzJs.Mvc.Mvc.Views.VerticalAlignment().Bottom;
                else
                    if (this.lastSpacer != null)
                        return WootzJs.Mvc.Mvc.Views.VerticalAlignment().Top;
                    else
                        throw System.InvalidOperationException.prototype.$ctor.$new().InternalInit(new Error());
    };
    $p.set_VerticalAlignment = function(value) {
        this.EnsureNodeExists();
        if (this.firstSpacer != null) {
            WootzJs.Web.NodeExtensions.Remove(this.firstSpacer);
            this.firstSpacer = null;
        ...
        switch (value) {
            ...
            case WootzJs.Mvc.Mvc.Views.VerticalAlignment().Middle:
                {
                    this.firstSpacer = WootzJs.Web.Browser().get_Document().createElement("tr");
                    var firstSpacerCell = WootzJs.Web.Browser().get_Document().createElement("td");
                    firstSpacerCell.style.height = "50%";
                    this.firstSpacer.appendChild(firstSpacerCell);
                    WootzJs.Web.NodeExtensions.Prepend(this.table, this.firstSpacer);
                    this.lastSpacer = WootzJs.Web.Browser().get_Document().createElement("tr");
                    var lastSpacerCell = WootzJs.Web.Browser().get_Document().createElement("td");
                    lastSpacerCell.style.height = "50%";
                    this.lastSpacer.appendChild(lastSpacerCell);
    ...
    $p.Add$1 = function(child) {
        this.Add$4(child, this.get_DefaultAlignment(), 0);
    };
    $p.Add$2 = function(child, alignment) {
        this.Add$4(child, alignment, 0);
    };
    $p.Add$3 = function(child, spaceAbove) {
        this.Add$4(child, this.get_DefaultAlignment(), spaceAbove);
    };

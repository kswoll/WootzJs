...
(WootzJs.Mvc.Mvc.Views.Control.$TypeInitializer = function($t, $p) {
    ...
    $p.add_Click = function(value) {
        ...
        this.click = $cast(System.Action, System.Delegate.Combine(this.click, value));
    };
    $p.remove_Click = function(value) {
        this.click = $cast(System.Action, System.Delegate.Remove(this.click, value));
        if (this.click == null)
...
(WootzJs.Mvc.Mvc.Views.IInlineControl.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Mvc.Mvc.Views.IInlineControl.$isStaticInitialized)
            return;
        WootzJs.Mvc.Mvc.Views.IInlineControl.$isStaticInitialized = true;
    };

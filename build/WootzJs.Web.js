...
(WootzJs.Web.Attr.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.Attr.$isStaticInitialized)
            return;
        WootzJs.Web.Attr.$isStaticInitialized = true;
...
(WootzJs.Web.Browser.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.Browser.$isStaticInitialized)
            return;
        WootzJs.Web.Browser.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
...
(WootzJs.Web.DocumentExtensions.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.DocumentExtensions.$isStaticInitialized)
            return;
        WootzJs.Web.DocumentExtensions.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Web.ElementExtensions.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.ElementExtensions.$isStaticInitialized)
            return;
        WootzJs.Web.ElementExtensions.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Web.IChildNode.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.IChildNode.$isStaticInitialized)
            return;
        WootzJs.Web.IChildNode.$isStaticInitialized = true;
    };
...
(WootzJs.Web.IParentNode.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.IParentNode.$isStaticInitialized)
            return;
        WootzJs.Web.IParentNode.$isStaticInitialized = true;
    };
...
(WootzJs.Web.NodeExtensions.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.NodeExtensions.$isStaticInitialized)
            return;
        WootzJs.Web.NodeExtensions.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
...
(WootzJs.Web.NodeType.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.NodeType.$isStaticInitialized)
            return;
        WootzJs.Web.NodeType.$isStaticInitialized = true;
...
(WootzJs.Web.PopStateEventHandler.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.PopStateEventHandler.$isStaticInitialized)
            return;
        WootzJs.Web.PopStateEventHandler.$isStaticInitialized = true;
...
(WootzJs.Web.StyleSheet.$TypeInitializer = function($t, $p) {
    ...
    $t.$StaticInitializer = function() {
        if (WootzJs.Web.StyleSheet.$isStaticInitialized)
            return;
        WootzJs.Web.StyleSheet.$isStaticInitialized = true;
        System.Object.$StaticInitializer();
    };
    $p.$ctor = function() {
        System.Object.prototype.$ctor.call(this);
